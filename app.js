...
//logger
/*
var logStream = fs.createWriteStream(path.join('logs', 'combined.log'), { flags: 'a' })
app.use(logger('combined', { stream: logStream }));
*/
var logStream = fs.createWriteStream(path.join('logs', 'dev.log'), { flags: 'a' })
app.use(logger('dev', { stream: logStream }));
/*
var logStream = fs.createWriteStream(path.join('logs', 'commen.log'), { flags: 'a' })
app.use(logger('commen', { stream: logStream }));

var logStream = fs.createWriteStream(path.join('logs', 'tiny.log'), { flags: 'a' })
